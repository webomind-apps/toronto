...
@section('main')
    ...
    <form action="{{ route('admin.paymentMethod.update',$paymentMethod) }}" enctype="multipart/form-data" method="post">
        @csrf
        @method("put")
            ...
            <div class="x_panel">
                <div class="x_content row">
                    ...
                    <div class="form-group col-md-4 image-div">
                        ...
                        @endif
                        <img id="image-preview" src="{{ asset('storage/'.$paymentMethod->image) }}" class="file-image-preview"/>
                    </div>
                    <div class="form-group col-md-8">
                    </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $(".module-title").text("Edit Payment Method");
