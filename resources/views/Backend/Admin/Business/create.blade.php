            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="col-lg-8 col-xs-12">
                        <form action="{{ route('admin.business.store') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="tab-content">
                                ...
                                <div id="genaral">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="date" name="upgraded_date"
                                                value="{{ old('upgraded_date') ?? date('Y-m-d') }}" required />
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="package_id" id="package_id" required>
                                                ...
                                                @foreach ($packages as $package)
                                                    <option {{ isSelected(old('package_id'), $package->id) }}
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="user_id" required>
                                                ...
                                                @foreach ($users as $user)
                                                    <option {{ isSelected(old('user_id'), $user->id) }}
                                                        value="{{ $user->id }}">{{ $user->fname }}
                                                        {{ $user->lname }}({{ $user->phone }})
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="description">Description
                                                : *</label>
                                            <textarea type="text" class="form-control editor" name="description" rows="6"
                                ...
                                <div id="location">
                                    ...
                                    <div class="row">
                                                ...
                                                @if (!$countries->isEmpty())
                                                    @foreach ($countries as $key => $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ isSelected(old('country_id'), $country->id) }} {{(($key==0)?"selected":"")}}>
                                                            {{ $country->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="hidden" id="place_lat" name="lat" value="{{ old('lat') }}">
                                            <input type="hidden" id="place_lng" name="lng" value="{{ old('lng') }}">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control alphanumeric code"
                                                placeholder="Postal Code" name="postcode" value="{{ old('postcode') }}"
                                ...
                                <div id="contact_info">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control email email-unique" data-field="email"
                                            name="email" required value="{{ old('email') }}" data-table="businesses">
                                        @if ($errors->has('email'))
                                ...
                                <div id="online_order_detail" class="row primium_pack_field_only">
                                    ...
                                    <div class="form-group col-md-6 oldiv" style="display:none;">
                                        <label for="name">Order Online Link: *</label>
                                        <input class="form-control" type="text" name="online_order_link"
                                            id="online_order_link" value="{{old("online_order_link")}}" />
                                ...
                                <div id="otherDetail" class="primium_pack_field_only">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control editor" name="product_and_service"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control editor" name="specialization"></textarea>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", "#social_addmore", function(event) {
                ...
                social_list.append(`
                    <div class="row form-group social_item">
                        <div class="col-md-6">
                            <select class="form-control website" name="social_names[]">
                                <option value="">Select</option>
            ...
            $(".open_or_closed").change(function(e) {
                e.preventDefault();
                if ($(this).val() == "Closed") {
                    $(this).parents(".openinghour_item").find(".opening_from_a_day,.opening_to_a_day").parent("div")
                        .hide();
            ...
            $('#gallery').change(function() {
                ...
                $.ajax({
                    url: "{{route('admin.business.galleryUpload')}}",
                    data: form_data,
                    type: 'POST',
                    contentType: false,
                    processData: false,
        ...
        function city_collection(province_id = null) {
            $.ajax({
                type: "get",
                url: "{{ route('admin.common.city.collection') }}",
                data: {
        ...
        function sub_category_collection(category_id = null) {
            $.ajax({
                type: "get",
                url: "{{ route('admin.common.subCategory.collection') }}",
                data: {
        ...
        function package_service() {
            ...
            if (package_id == 2) {
                ...
                $(".primium_pack_field_only").find('input,textarea,select').attr("required",false);
