            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="col-lg-8 col-xs-12">
                        <form action="{{ route('admin.business.update', $business) }}" enctype="multipart/form-data"
                            method="post">
                            @csrf
                            @method("put")
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="date" name="upgraded_date"
                                                value="{{ old('upgraded_date') ?? $business->business_upgrade_latest->upgraded_date ? date('Y-m-d', strtotime($business->business_upgrade_latest->upgraded_date)) : date('Y-m-d') }}"
                                                required />
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="package_id" id="package_id" required>
                                                ...
                                                @foreach ($packages as $package)
                                                    <option
                                                        {{ isSelected(old('package_id') ?? $business->business_upgrade_latest->package_id, $package->id) }}
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="user_id" required>
                                                ...
                                                @foreach ($users as $user)
                                                    <option
                                                        {{ isSelected(old('user_id') ?? $business->user->id, $user->id) }}
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".icon-delete", function(event) {
                ...
                if (confirm("Are you sure to remove?")) {
                    ...
                    // $.ajax({
                    //     type: "get",
                    //     url: "{{ route('admin.business.galleryRemove') }}",
                    //     data: {
                    //         "id" : vm.attr("data-id"),
                    //         "_ token" : "{{ csrf_token() }}",
                    //     },
