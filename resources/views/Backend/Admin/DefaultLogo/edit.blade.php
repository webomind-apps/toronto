...
@section('main')
    ...
    <form action="{{ route('admin.defaultLogo.update',$defaultLogo) }}" enctype="multipart/form-data" method="post">
        @csrf
        @method("put")
            ...
            <div class="x_panel">
                <div class="x_content row">
                    <div class="form-group col-md-4 image-div">
                        ...
                        @endif
                        <img id="image-preview" src="{{ asset('storage/'.$defaultLogo->image) }}" class="file-image-preview"/>
                    </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $(".module-title").text("Add Default Logo");
