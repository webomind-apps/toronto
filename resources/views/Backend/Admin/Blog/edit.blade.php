                                ...
                                <div id="genaral">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea type="text" class="form-control editor" name="description" rows="6">{{ $blog->description }}</textarea>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea type="text" class="form-control" name="meta_description" rows="6">{{ $blog->meta_description }}</textarea>
