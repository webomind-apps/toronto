...
class CreateBusinessSubCategoryTempsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('business_sub_category_temps', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('business_sub_category_temps');
    }
}
