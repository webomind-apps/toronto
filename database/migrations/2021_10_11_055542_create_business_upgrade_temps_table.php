...
class CreateBusinessUpgradeTempsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('business_upgrade_temps', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('business_upgrade_temps');
    }
}
