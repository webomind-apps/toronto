...
//         url: getUrlAPI('/place/status', 'api'),
//         method: "put",
//         body: {
//             "place_id": place_id,
//             "status": status ? 1 : 0
...
$(document).on("click", "#social_addmore", function(event) {
    ...
    social_list.append(`
            <div class="row form-group social_item" id="social_item_${social_item}">
                <div class="col-md-5">
                    <select class="form-control website" name="social[${social_item}][name]">
                ...
                <div class="col-md-6 websiteDiv">
                    <input type="text" class="form-control website" name="social[${social_item}][url]" placeholder="Enter URL(www.google.com)">
                    ...
                    let html = `
                                <div class="col-sm-2 media-thumb-wrap">
                                    <figure class="media-thumb">
                                        <img src="${base_url}/uploads/${res.file_name}">
